public class PostfixEvaluationLinkedList 
{
    public static void main(String[] args) 
    {
        System.out.println("Testing PostfixEvaluationLinkedList:\n");
   ...
   public static double evaluatePostfix(String postfix)   {
      LinkedListStack<Double> valueStack = new LinkedListStack<>();
...
} // end PostfixEvaluationLinkedList